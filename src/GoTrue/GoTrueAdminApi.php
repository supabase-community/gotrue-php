...
class GoTrueAdminApi
{
    ...
    public function createUser($attrs)
    {
        try {
            ...
            $headers = array_merge($this->headers, ['Content-Type' => 'application/json', 'noResolveJson' => true]);
            $response = $this->__request('POST', $url, $headers, $body);return ['data' => $response, 'error' => null];
        } catch (\Exception $e) {
            throw $e;
        }
    }
     ...
     * @param boolean $shouldSoftDelete If true, then the user will be soft-deleted from the auth schema.
